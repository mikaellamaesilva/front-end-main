  ...
  .p-5
    ...
    el-form(label-position='left' label-width='140px' :model='modelValue' @submit.prevent='$emit("submitForm", $event)' enctype='multipart/form-data')
      ...
      el-form-item(label='Birth date')
        .w-100(v-if="mode !== 'view'")
          el-date-picker.w-100.date-input(type="date"  format="MMMM D, YYYY" value-format="YYYY-MM-DD" v-model='modelValue.birthDate' @change="validateBirthDate" name="birthDate" required)
